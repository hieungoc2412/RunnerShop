	...
	*/
	...
	doBeforeProcessing(request, response);
        ...
        UserDAO udao = new UserDAO();
            UserHieu a = (UserHieu) udao.getUser(request.getParameter("uid"));
            if(a.getRoleID()==2){
                req.setAttribute("user", a);
                request.getRequestDispatcher("HieuPTM/dined.jsp").forward(request, response);
            }
